...
async function main() {
    ...
    const bToken = await hre.ethers.getContractAt("HODL", "0xFfF54fcdFc0E4357be9577D8BC2B4579ce9D5C88");
    ...
    const treasuryDAO = await hre.ethers.getContractAt("Treasury", "0x98F5cdda1489503e755Da30BEc5FCD341C949791");
    ...
    const theoretics = await hre.ethers.getContractAt("Theoretics", "0x670433FB874d4B7b94CF1D16E95fa241474E6787");
    ...
    const genesisPool = await hre.ethers.getContractAt("GameGenesisRewardPool", "0x9D5D593Cf8FB6bF3Edb1c1D6dAf37714aF1A0F6C")
    ...
    const theoryRewardPool = await hre.ethers.getContractAt("TheoryRewardPool", "0x820c3b6d408Cff08C8a31C9F1461869097ba047c");
    //     sToken.address,
    //     treasuryDAO.address,
    //     theoryStartTime,
    //     weeks, // 7 days
    ...
    let pTokenPairAddress = '0x168e509FE5aae456cDcAC39bEb6Fd56B6cb8912e';
    //console.log("-- GAME-DAI LP deployed to:", pTokenPairAddress);
    let sTokenPairAddress = '0xF69FCB51A13D4Ca8A58d5a8D964e7ae5d9Ca8594';
